...
export default function Index({ constancias = [], filters }) {
    ...
    // ✅ CORREGIDO: Simplemente abre el PDF sin filtros previos
    const reportePorPeriodo = () => {
        // Por ahora abre el PDF con todos los datos
        // Puedes agregar filtros más adelante si necesitas
        window.open('/capacitaciones/reporte/pdf', '_blank');
    };
