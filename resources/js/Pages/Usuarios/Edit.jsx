            ...
            <div className="p-8">
              ...
              <div className="mb-8 pb-6 border-b border-gray-200">
                ...
                <p className="text-gray-600 mt-2">
                  Modifique los campos que desea actualizar para el usuario <strong>{user.name}</strong>
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      } focus:border-blue-600 focus:ring focus:ring-blue-200 transition-colors`}
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="mb-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    <p className="text-sm text-yellow-800">
                      <strong>Nota:</strong> Solo complete estos campos si desea cambiar la contraseña. Si los deja en blanco, la contraseña actual se mantendrá sin cambios.
                    </p>
                  </div>
