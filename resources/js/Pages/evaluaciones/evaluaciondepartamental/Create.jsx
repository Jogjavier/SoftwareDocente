...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post("/evaluaciones/evaluaciondepartamental", {
            docente_id,
            carrera_id,
            periodo,
            anio,
            ...
            <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg p-10 border border-gray-200">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* CAMPOS NUMÉRICOS */}
                        <InputNumber label="Docencia" value={docencia} setValue={setDocencia} />
                        <InputNumber label="Tutoría" value={tutoria} setValue={setTutoria} />
                        <InputNumber label="Vinculación" value={vinculacion} setValue={setVinculacion} />
                        <InputNumber label="Gestión" value={gestion} setValue={setGestion} />
                        <InputNumber label="Global" value={global} setValue={setGlobal} />
